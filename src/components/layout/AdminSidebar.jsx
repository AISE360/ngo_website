    ...
    <div className="flex flex-col h-full w-full">
      ...
      <div className="px-4 py-4 border-t border-white/10">
        ...
        <button
          ...
          className="btn-no-flash w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-medium text-gray-300 hover:bg-red-500/20 hover:text-red-300 transition-colors"
        >
